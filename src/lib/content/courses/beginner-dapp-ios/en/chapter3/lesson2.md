...
<img src="https://i.imgur.com/m3nHNVU.png" alt="drawing" size="400" />
...
<img src="https://i.imgur.com/PYpUbvU.png" alt="drawing" size="400" />
...
> Load up the flow playground [https://play.onflow.org](https://play.onflow.org), copy this contract into the `0x01` account, and click "Deploy":
...
<img src="https://i.imgur.com/NoyDYE4.png" alt="drawing" size="400" />
...
Boom! This is an empty transaction that doesn't do anything. In order to explain what `prepare` and `execute` do, we need to take a quick break and talk about accounts on Flow.
...
Alright, so we want to change our `greeting` field to something other than "Hello, World!" But there's a problem. We never added a way to modify our data in the smart contract! So we have to add a function in the contract to do that.
...
<img src="https://i.imgur.com/bhDYpy7.png" alt="drawing" size="400" />
