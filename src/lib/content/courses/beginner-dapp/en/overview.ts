	...
	metadata: {
		...
		faqs: [
			...
			},
			{
				...
				answer: '<ul><li>An intro to the Flow blockchain (Chapter 1)</li><li>Do some front-end development (Chapter 2)</li><li>How to do basic styling (Chapter 2)</li><li>How to make your own DApp (Chapters 2-5)</li><li>How to do some Cadence coding (Chapter 3)</li><li>Connect your DApp to the blockchain (Chapter 3-5)</li></ul>'
			},
			{
				question: '🔖 What will I create?',
				answer: 'Click <a href="https://beginner-emerald-dapp.vercel.app/" target="_blank">here</a> to see what you will be creating.'
			},
			{
				question: '😇 Who is this course NOT meant for?',
				answer: "<ul><li>People who have already created very basic DApps using FCL. This will be too boring for you.</li></ul>"
			},
			{
				question: '📚 How does it work?',
				answer: "The lessons will be split into 'chapters,' and chapters will be split into 'days.' I did it this way so you can manage your time and progress through the course as you like. Do not feel pressured to do this every day. Do it at your own pace and have fun with it! It will always be here :)<br/><br/>Here's an overview:<ul><li>Lessons split into days</li><li>Written & video content associated with each day. The videos will be from my <a href='https://www.youtube.com/channel/UCf6DzMRwj7SJ3nPrZqd5hHw' target='_blank'>YouTube Channel</a>.</li><li>Quests to complete</li><li>Short quizzes</li><li>A completion certificate (<a href='https://floats.city/jacob.find/event/701829091' target='_blank'>this FLOAT</a>) if you have completed all the quests from Chapters 1-5 (Chapter 6 is extra credit). This will be proof that you have significant Cadence knowledge, and you will be able to show it to whoever you like as proof of expertise. Or just for fun! :D</li></ul>"
			},
			{
