...
export const overview: SnippetOverview = {
  ...
  excerpt: 'Sign a user message with FCL on the frontend.',
  metadata: {
    subjects: [SubjectsEnum.DApp, SubjectsEnum.Javascript]
  },
  codeLink: 'https://codesandbox.io/s/fcl-sign-message-tcvhjy?file=/src/index.js'
};
