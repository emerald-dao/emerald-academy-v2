<script type="ts">
	...
	export let type: ContentTypeEnum | SubjectsEnum | ExpertiseEnum;
...
{:else if type === ContentTypeEnum.Tweet}
	<Label
		size="small"
		iconLeft={IconEnum.Twitter}
		color="neutral"
		iconColor="#26a7de"
		{state}
		hasBorder={false}><slot /></Label
	>
{:else if type === ContentTypeEnum.YouTube}
	<Label
		size="small"
		iconLeft={IconEnum.YouTube}
		color="neutral"
		iconColor="#FF0000"
		{state}
		hasBorder={false}><slot /></Label
